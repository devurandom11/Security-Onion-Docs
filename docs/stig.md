...
In addition to the required partitions, using the STIG menu option will also configure the system to use [FIPS](fips.md) mode, and enable [LUKS](luks.md) disk encryption. Both of these options can be used independently of the STIG menu option depending on your requirements.
