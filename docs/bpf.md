...
You can modify your BPF configuration by going to [Administration](administration.md) --> Configuration --> bpf. You can apply BPF configuration to [Suricata](suricata.md) or [Zeek](zeek.md). If you configure a BPF for Suricata, then it can apply to alerts, metadata, and/or [Full Packet Capture](full-packet-capture.md).
