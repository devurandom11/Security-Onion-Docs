...
Zeek logs are sent to [Elasticsearch](elasticsearch.md) where they are parsed using ingest parsing. Most Zeek logs have a few standard fields and they are parsed as follows:
